...
public class Set_Alarm extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// To initialize the date and Time with the current date and time
		...
		save.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// To get current date and time to see if the alarm is not being set in the passed date/time
			    ...
			    if(set.compareTo(current) <= 0){
			     //The set Date/Time already passed
			        Toast.makeText(getApplicationContext(), 
			          "Invalid Date/Time - Date/Time in Past", 
